...
public interface PropertyGraph {
     ...
     */
    Traversable<Edge> getEdges(NodeId node, EdgeType edgeType, EdgeDirection direction);

    /**
     * Gets an iterable of neighbors for a node.
     */
    Traversable<Node> getNeighbors(NodeId node, EdgeType edgeType, EdgeDirection direction);
