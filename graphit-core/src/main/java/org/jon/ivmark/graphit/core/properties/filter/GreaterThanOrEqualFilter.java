...
public class GreaterThanOrEqualFilter extends NumberFilter {

    private final Object target;

    public GreaterThanOrEqualFilter(Object target, NumberComparatorFactory numberComparatorFactory) {
