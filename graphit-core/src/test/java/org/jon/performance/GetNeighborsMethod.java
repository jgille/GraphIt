 ...
 * 
 */
public class GetNeighborsMethod extends GraphTraversalMethod {

    public GetNeighborsMethod(PropertyGraph graph, GraphLoadTestStats stats) {
        super(graph, stats);
    }
    ...
    protected Integer
        ...
        int count = getGraph().getNeighbors(nodeId, edgeType, edgeDirection).size();
        getStats().logGetNeighbors(count);
        return count;
    }
