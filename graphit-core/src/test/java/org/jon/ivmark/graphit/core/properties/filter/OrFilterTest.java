...
public class OrFilterTest {
    ...
    public void testEmptyFilters() {
        new OrFilter(Collections.<Map<String, Object>>emptyList()).apply("test");
    }

    @Test
    public void testCompoundFiltersAllValid() {
        ...
        boolean valid = new OrFilter(filters).apply("test");
        assertTrue(valid);
    }

    @Test
    public void testCompoundFiltersSomeValid() {
        List<Map<String, Object>> filters = new ArrayList<Map<String, Object>>();
        filters.add(Collections.<String, Object>singletonMap("exists", true));
    ...
    public void testNegativeCompoundFilters() {
        List<Map<String, Object>> filters = new ArrayList<Map<String, Object>>();
        filters.add(Collections.<String, Object>singletonMap("exists", false));
        filters.add(Collections.<String, Object>singletonMap("eq", "other"));
        boolean valid = new OrFilter(filters).apply("test");
        assertFalse(valid);
    }
