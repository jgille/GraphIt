...
public class EdgePrimitiveTest {
    ...
    public void testGetters() {
        EdgeId edgeId = new EdgeId(TestEdgeTypes.SIMILAR, 1);
    ...
    public void testEquals() {
        EdgeId edgeId1 = new EdgeId(TestEdgeTypes.SIMILAR, 1);
        EdgePrimitive edge1 = new EdgePrimitive(edgeId1, 2, 3, 4.5f);

        EdgeId edgeId2 = new EdgeId(TestEdgeTypes.SIMILAR, 1);
        EdgePrimitive edge2 = new EdgePrimitive(edgeId2, 2, 3, 4.5f);

        EdgeId edgeId3 = new EdgeId(TestEdgeTypes.SIMILAR, 2);
    ...
    public void testHashCode() {
        ...
        EdgeId edgeId2 = new EdgeId(TestEdgeTypes.SIMILAR, 2);
        EdgePrimitive edge2 = new EdgePrimitive(edgeId2, 2, 3, 4.5f);
